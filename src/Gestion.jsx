...
const Gestion = () => {
  ...
  useEffect(() => {
    setLogged(false);
    // Hacer la solicitud al backend para verificar si el token es válido
    Axios.post("http://localhost:5000/getUsers", {}, { withCredentials: true })
      .then((response) => {
  ...
  useEffect(() => {
    ...
    if(username!=null&&username.rol!='admin'){
        navigate('/'); // Aquí rediriges a la página protegida
    }
        ...
        <div className='absolute h-full w-full bg-[rgb(0,0,0,0.3)] z-10'>
          ...
          <figure className="w-16">
            ...
            ></img>
                ...
                <div className='xl:w-10/12 w-11/12 bg-amber-100 m-auto mt-10'>
                    <div className='font-semibold text-2xl flex items-center gap-4'>
                        ...
                        <FormattedMessage  id='resumen_gestion' />   
                    </div>
         ...
         <GridUsers users={users} lang={lang} />
